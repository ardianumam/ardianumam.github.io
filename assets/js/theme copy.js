...
let applyTheme = () => {
  let theme = determineComputedTheme(); // return either dark or light 
...
let determineThemeSetting = () => {
  ...
  //   console.log("NULL ---> themeSetting:", themeSetting);  
  // } else {
...
let determineComputedTheme = () => {
  ...
  if (themeSetting == "system") {
    ...
    // console.log(" ---> media:", userPref("(prefers-color-scheme: dark)").media)
