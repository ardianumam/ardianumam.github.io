...
My name is Ardian Umam (禹安銳), you can call me Ardian, or 安銳 (An-Rui) in Chinese. I am a Senior AI/Machine Learning Engineer at [Qualcomm](https://www.qualcomm.com/), working on 3D human avatar and human motion estimation. I received my Ph.D. from [National Yang Ming Chiao Tung University](https://www.nycu.edu.tw/nycu/en), Taiwan, advised by [Prof. Yen-Yu Lin](https://sites.google.com/site/yylinweb/) ([VLLab](http://vllab.cs.nycu.edu.tw/)) and [Prof. Jen-Hui Chuang](https://www.cs.nycu.edu.tw/members/detail/jchuang) ([Islab](http://islab.cs.nctu.edu.tw/joomla/)). 

My field interests are (but not limited to) deep learning, computer vision, natural language processing, and multi-modal AI. Over the past 8 years, I have been working on various topics which involve 1D data (audio and languange), 2D data (image) and 3D data (point cloud and mesh). The tasks include audio quality estimation, optical character recognition, camera calibration, 3D segmentation, multi-modal (vision-language) recognition, large language models using RAG (Retrieval Augmented Generation), and 3D human avatar. Additionally, I interned at [Google](https://google.com) with the ChromeOS Audio Team and at [ITRI](https://www.itri.org.tw/english/index.aspx) working on model compression.